## GRC Homework: Assessing Security Culture 
...
For this week's homework assignment, you will research these security risks and use the security culture framework to develop a plan to mitigate the concerns.

Below are the deliverables for this week's assignment.
...
- You can submit all four deliverables in the same document. Make sure that anyone can view and comment on your document. 
