...
fping -g -r 1 167.172.144.11/32
nmap -sS 167.172.144.11
ssh jimi@167.172.144.11
user : jimi / password : Hendrix
nslookup rollingstone.com
ping -c 1 rollingstone.com
$ cat etc/hosts
nslookup 98.137.246.8
cat /etc/packetcaptureinfo.txt
Download the pcap file from https://drive.google.com/file/d/1ic-CFFGrbruloYrWaw3PvT71elTkh3eF/view?usp=sharing
Analyze Frame 4 vs 5 and Frame 16 vs 17 from Wireshark using the pcap file.

  - List any vulnerabilities discovered.
Dynamic IP Configuration
Port 22 is Open
Root folders unsecured
...
Change the value of manage_etc_hosts: true to false from /etc/cloud/cloud.cfg to avoid changes on the etc/hosts table
use static IP configuration 
delete line: 98.137.246.8 rollingstone.com in etc/hosts file 
secure port 22.
block IP address 98.137.246.8  (Hackers IP address)
Disabling allowing ICMP responses from the server IP
